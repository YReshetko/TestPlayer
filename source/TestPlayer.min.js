...
InteractiveTask.Player = function(options){
	...
	//  œÓÔ˚ÚÍ‡ Á‡„ÛÁËÚ¸ Ë ÔÂÂÌ‡ÒÚÓËÚ¸ ÍÓÌÒÚ‡ÌÚ˚ ÔÎÂÂ‡
	try{
...
/*ÃÂÚÓ‰ Ó˜ËÒÚÍË ÔÎÂÂ‡ ÔÓÒÎÂ Â„Ó ÓÚ‡·ÓÚÍË*/
...
InteractiveTask.Player.prototype.getOutResult = function(){
	...
	var maxScore = 0;
	var currentScore = 0;
	var cTaskResult = 0; // ÂÁÛÎ¸Ú‡Ú ÚÓÎ¸ÍÓ ‰Îˇ ÚÂÍÛ˘Â„Ó Á‡‰‡ÌËˇ
	var taskID = 0;
	var deltaScore;
	var deltaTime;
...
/**
 * ¬˚˜ËÒÎÂÌËÂ ÂÁÛÎ¸Ú‡Ú‡ ‰Îˇ i-Ó„Ó Á‡‰‡ÌËˇ Ò Û˜ÂÚÓÏ Ù‡ÍÚÓÓ‚ ‚ÎËˇ˛˘Ëı Ì‡ ÔÓÌËÊÂÌËÂ ·‡ÎÎ‡ (ÔÓ‰‚Ó‰ˇ˘ËÂ, ÊËÁÌË, Ú‡ÈÏÂ)
 * @param i
 * @returns {number}
 */
...
InteractiveTask.Player.prototype.prepareArrayTaskOptions = function(){
    ...
    for(i=0;i<l;i++){
        ...
        this.outResult[i] = {
            ...
            isComplate : false,
	        maximumResult : maxResult,  // ‚ÁˇÚ¸ ‰‡ÌÌ˚È ÂÁÛÎ¸Ú‡Ú ËÁ Ù‡ÈÎ‡ Á‡‰‡ÌËˇ (‡Á‡·ÓÚ‡Ú¸ ‚ ÍÓÌÒÚÛÍÚÓÂ ÛÒÚ‡ÌÓ‚ÍÛ ·‡ÎÎÓ‚)
	        numHelping : 0, // ÛÍ‡Á˚‚‡Ú¸ ÛÓ‚ÂÌ¸ ÔÓ‰‚Ó‰ˇ˘Â„Ó Á‡‰‡ÌËˇ ‰Îˇ ÓÔÂ‰ÂÎÂÌËˇ ÔÓÌËÊ‡˛˘Â„Ó ·‡Î‡
            comment : "",
...
// «‡‚Â¯ÂÌËÂ Á‡‰‡ÌËˇ ÔË Ó¯Ë·ÍÂ
// - «‡ÍÓÌ˜ËÎÒˇ Ú‡ÈÏÂ
// - «‡ÍÓÌ˜ËÎËÒ¸ ÊËÁÌË
// - Õ‡Ê‡Ú‡ ÍÌÓÔÍ‡ "ÕÂ ÁÌ‡˛" ‚ ÚÂÒÚÂ
...
// «‡‚Â¯ÂÌËÂ Á‡‰‡ÌËˇ „Ë·Ë‰ÌÓ„Ó ÂÊËÏ‡ ÔË ÔÓ‚ÚÓÌÓÈ Ó¯Ë·ÍÂ
// - Á‡ÍÓÌ˜ËÎÒˇ Ú‡ÈÏÂ ‰‚‡Ê‰˚
// - Á‡ÍÓÌ˜ËÎËÒ¸ Ó¯Ë·ÍË ‰‚‡Ê‰˚
...
// Õ‡Ê‡Ú‡ ÍÌÓÔÍ‡ "–ÂÒÚ‡Ú" ËÎË ÔÂÂÁ‡„ÛÁÍ‡ Á‡‰‡ÌËˇ ÔÓ ‰Û„ÓÈ ÔË˜ËÌÂ
...
// ≈ÒÚ¸ ÎË Û Á‡‰‡ÌËˇ Ò‚ˇÁ‡ÌÌÓÂ ‡Û‰ËÓ Ë ‰ËÒÔ‡Ú˜ËÚ ‚ ÒÎÛ˜‡Â ÌÂÓ·ıÓ‰ËÏÓÒÚË
...
// œÓÎÛ˜ÂÌËÂ ÒÎÂ‰Û˛˘Â„Ó Á‡‰‡ÌËˇ ÔË ‡ÁÎË˜Ì˚ı ÒÓ·˚ÚËˇı
...
// œÓÎÛ˜ÂÌËÂ ÌÓÏÂ‡ ÒÎÂ‰Û˛˘Â„Ó Á‡‰‡ÌËˇ ‚ ‰ËÙÙÂÂÌˆËÓ‚‡ÌÌÓÏ ‰ÂÂ‚Â  ÔË ÔÓÁËÚË‚ÌÓÏ ÔÂÂıÓ‰Â:
// - ÛÒÔÂ¯ÌÓÂ Á‡‚Â¯ÂÌËÂ
// - ÍÌÓÔÍ‡ ˇ ÔÓÌˇÎ
// - Ó¯Ë·Í‡ ‚ ÏÌËÏÓÏ
...
// œÓÎÛ˜ÂÌËÂ ÌÓÏÂ‡ ÒÎÂ‰Û˛˘Â„Ó Á‡‰‡ÌËˇ ‚ ÎËÌÂÈÌÓÏ ÒÔËÒÍÂ
// ‚ÓÁ‚‡˘‡ÂÚ -1 ÂÒÎË ÒÎÂ‰Û˛˘Â„Ó ÌÂÚ
// ‚ÓÁ‚‡˘‡ÂÚ ID ÂÒÎË ÂÒÚ¸
...
InteractiveTask.Player.prototype.startCurrentTask = function(){
	...
	if(this.currentTaskID!=-1){
		//  ÔÂÂ‰ Ì‡˜‡ÎÓÏ Á‡‰‡ÌËˇ, ‚ ÒÎÛ˜‡Â ÌÂÓ·ıÓ‰ËÏÓÒÚË ÒÌËÊ‡ÂÏ ·‡ÎÎ Á‡ ÔÓÎÛ˜ÂÌÌÛ˛ ÔÓÏÓ˘¸
		this.downScore();
...
/********************************************
 * ÛÒÚ‡Ì‡‚ÎË‚‡ÂÏ ÒÌËÊ‡˛˘ËÈ ·‡ÎÎ Ì‡ Á‡‰ÌËÂ
 * @returns {*}
 */
...
InteractiveTask.SampleMark = function(options){
	...
	if(this.xml.STARTANIMATIONCOMPLATE != undefined){
		//this.startLabelComplate = this.xml.STARTANIMATIONCOMPLATE;
		/*
		 –º–µ–Ω—è–µ–º –Ω–∞ —Å–æ–∑–¥–∞–Ω–∏–µ –º–∞—Å—Å–∏–≤–∞ –º–µ—Ç–æ–∫ –∞–Ω–∏–º–∞—Ü–∏–∏
		 */
    ...
    //TODO: –≤–≤–µ—Å—Ç–∏ touchstart –∏ –ø—Ä–æ–≤–µ—Ä–∏—Ç—å –Ω–∞ –ø–ª–∞–Ω—à–µ—Ç–∞—Ö
...
/*
 –£—Å—Ç–∞–Ω–æ–≤–∫–∞ –æ–±–ª–∞—Å—Ç–∏ –≤–Ω–µ—Å–µ–Ω–∏—è –≤ —Å–ª—É—á–∞–µ –µ—Å–ª–∏ —ç—Ç–æ –Ω–æ–±—Ö–æ–¥–∏–º–æ  ///////////////////////////////////////////////////////////////////////////////////
 */
...
// –ü—Ä–æ–≤–µ—Ä–∫–∞: –∏–∑–æ–±—Ä–∞–∂–µ–Ω–∏–µ –∏–ª–∏ –ø—É—Å—Ç–æ /////////////////////////////////////////////////////////////////////////////////////
...
// –ü—Ä–æ–≤–µ—Ä–∫–∞ –Ω–∞ —Å–ª—É—á–∞–π–Ω—É—é –ø–æ–∑–∏—Ü–∏—é –≤–æ–ø—Ä–æ—Å–∞/–∏–∑–æ–±—Ä–∞–∂–µ–Ω–∏—è ///////////////////////////////////////////////////////////////////
...
// –ü—Ä–æ–≤–µ—Ä–∫–∞: –≤–æ–ø—Ä–æ—Å –∏–ª–∏ –∏–∑–æ–±—Ä–∞–∂–µ–Ω–∏–µ ////////////////////////////////////////////////////////////////////////////////////
    if(this.xml.QUESTION == "false"){
...
/**
 * –?—Å–ø—Ä–∞–≤–∏—Ç—å —Ä–∞–±–æ—Ç—É —Å–æ —Å–ª–æ—è–º–∏
 * @param options
 * @constructor
 */
...
// –ü—É—Ç—å –¥–æ –º–µ—Å—Ç–æ—Ä–∞—Å–ø–æ–ª–æ–∂–µ–Ω–∏—è –∫–∞—Ä—Ç–∏–Ω–∫–∏ + –Ω–∞–∑–≤–∞–Ω–∏–µ —Å–∞–º–æ–π –∫–∞—Ä—Ç–∏–Ω–∫–∏ ////////////////////////////////////////////////////////
...
// –î–æ–±–∞–≤–ª—è–µ–º —ç–ª–µ–º–µ–Ω—Ç—ã –Ω–∞ —Å–ª–æ–π —Å —É—á–µ—Ç–æ–º —Ç–µ–≥–æ–≤ xml ///////////////////////////////////////////////////////////////////////
            net[i][j].id=id_net++;
            net[i][j].done=false;
...
// –û–±—Ä–∞–±–æ—Ç–∫–∞ –≤–∑–∞–∏–º–æ–¥–µ–π—Å—Ç–≤–∏–π —Å –ø–∞–∑–ª–æ–º (–≤—Ä–∞—â–µ–Ω–∏–µ, –ø–µ—Ä–µ–º–µ—â–µ–Ω–∏–µ) ////////////////////////////////////////////////////////////
	var self = this.controller;
    for(n=0;n<numCol;n++){
        for(m=0;m<numLine;m++){
...
// –û–±—Ä–∞–±–æ—Ç–∫–∞ –ø–æ–ø–∞–¥–∞–Ω–∏—è –ø–∞–∑–ª–∞ –≤ –∫–ª–µ—Ç–∫—É –∏ –ø—Ä–æ–≤–µ—Ä–∫–∞ –Ω–∞ –ø—Ä–∞–≤–∏–ª—å–Ω–æ—Å—Ç—å ///////////////////////////////////////////////////////
...
// –§—É–Ω–∫—Ü–∏–∏ –ø–æ–ª—É—á–µ–Ω–∏—è –ø–æ–¥—Å–∫–∞–∑–∫–∏ –∏ –ø—Ä–æ–≤–µ—Ä–∫–∏ —Ä–µ–∑—É–ª—å—Ç–∞—Ç–∞ ///////////////////////////////////////////////////////////////////
...
//	console.log("this.colorTan.strokeAlpha() = " + this.colorTan.strokeAlpha());
    ...
    if(this.xml.BLACK.DELETE == "1"){
	    ...
	    /*—Å–≤–æ–π—Å—Ç–≤–æ –¥–ª—è —Ñ—É–Ω–∫—Ü–∏–∏ –ø–µ—Ä–µ–º–µ—â–µ–Ω–∏—è/–≤—Ä–∞—â–µ–Ω–∏—è –æ–±—ä–µ–∫—Ç–æ–≤ —É—Å—Ç–∞–Ω–∞–≤–ª–∏–≤–∞–µ—Ç—Å—è –≤ true –¥–ª—è —Ç–æ–≥–æ —á—Ç–æ–±—ã –≤—ã—á–∏—Å–ª—è–ª–∞—Å—å –æ–±–ª–∞—Å—Ç—å –∫–µ—à–∏—Ä–æ–≤–∞–Ω–∏—è
	    *  —Ç–æ–ª—å–∫–æ –¥–ª—è –ø–æ–ª—å–∑–æ–≤–∞—Ç–µ–ª—å—Å–∫–∏—Ö —Ç–∞–Ω–æ–≤*/
...
InteractiveTask.SampleUserTan.prototype.colorableEnabled = function(){
    ...
    try{    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        if(this.xml.COLOR.PAINT == "1"){
	        ...
	        // –Ω–µ—è–≤–Ω–∞—è –ø—Ä–æ–≤–µ—Ä–∫–∞ –Ω—É–∂–Ω–æ–≥–æ —Ü–≤–µ—Ç–∞ –Ω–∞ –¥–æ—Ñ–æ–ª—Ç–æ–≤–æ—Å—Ç—å, –µ—Å–ª–∏ –æ–Ω–∏ —Å–æ–≤–ø–∞–¥–∞—é—Ç, —Ç–æ —Ç–∞–Ω —Ä–∞—Å–∫—Ä–∞—à–µ–Ω –≤–µ—Ä–Ω–æ
...
//  –û–ø—Ä–µ–¥–µ–ª—è–µ—Ç —É—Å—Ç–∞–Ω–∞–≤–ª–∏–≤–∞—Ç—å –ª–∏ —Ç–∞–Ω—ã –Ω–∞–∑–∞–¥ –Ω–∞ —Å–≤–æ—é –≥–ª—É–±–∏–Ω—É –≤ —Å–ª–æ–µ (–¥–ª—è –ø–µ—Ä–µ–º–µ—â–µ–Ω–∏—è –∏ –∞–Ω–∏–º–∞—Ü–∏–∏)
...
//  –î–æ–ø—É—Å—Ç–∏–º—ã–µ –∫–æ–Ω—Å—Ç–∞–Ω—Ç—ã –¥–ª—è –≤—ã—Ä–∞–≤–Ω–∏–≤–∞–Ω–∏—è –∫–Ω–æ–ø–∫–∏ –∑–≤—É–∫–∞ –ø–æ –≤–µ—Ä—Ç–∏–∫–∞–ª–∏: top, center, bottom
InteractiveTask.Const.prototype.SOUND_VERTICAL_ALIGN = "top";
//  –î–æ–ø—É—Å—Ç–∏–º—ã–µ –∫–æ–Ω—Å—Ç–∞–Ω—Ç—ã –¥–ª—è –≤—ã—Ä–∞–≤–Ω–∏–≤–∞–Ω–∏—è –∫–Ω–æ–ø–∫–∏ –∑–≤—É–∫–∞ –ø–æ –≥–æ—Ä–∏–∑–æ–Ω—Ç–∞–ª–∏: left, center, right
InteractiveTask.Const.prototype.SOUND_HORIZONTAL_ALIGN = "left";

//  –û—Ç—Å—Ç—É–ø –æ—Ç –æ–ø—Ä–µ–¥–µ–ª–µ–Ω–Ω–æ–≥–æ –∫—Ä–∞—è –ø–æ –æ—Å–∏ –•
InteractiveTask.Const.prototype.SOUND_DELTA_X = 70;
//  –û—Ç—Å—Ç—É–ø –æ—Ç –æ–ø—Ä–µ–¥–µ–ª–µ–Ω–Ω–æ–≥–æ –∫—Ä–∞—è –ø–æ –æ—Å–∏ Y
InteractiveTask.Const.prototype.SOUND_DELTA_Y = 5;

//  –î–æ–ø—É—Å—Ç–∏–º—ã–µ –∫–æ–Ω—Å—Ç–∞–Ω—Ç—ã –¥–ª—è –≤—ã—Ä–∞–≤–Ω–∏–≤–∞–Ω–∏—è –∫–Ω–æ–ø–∫–∏ –ø–æ–ª–Ω–æ—ç–∫—Ä–∞–Ω–Ω–æ–≥–æ —Ä–µ–∂–∏–º–∞ –ø–æ –≤–µ—Ä—Ç–∏–∫–∞–ª–∏: top, center, bottom
InteractiveTask.Const.prototype.FULLSCREEN_VERTICAL_ALIGN = "top";
//  –î–æ–ø—É—Å—Ç–∏–º—ã–µ –∫–æ–Ω—Å—Ç–∞–Ω—Ç—ã –¥–ª—è –≤—ã—Ä–∞–≤–Ω–∏–≤–∞–Ω–∏—è –∫–Ω–æ–ø–∫–∏ –ø–æ–ª–Ω–æ—ç–∫—Ä–∞–Ω–Ω–æ–≥–æ —Ä–µ–∂–∏–º–∞ –ø–æ –≥–æ—Ä–∏–∑–æ–Ω—Ç–∞–ª–∏: left, center, right
...
//  –î–æ–ø—É—Å—Ç–∏–º—ã–µ –∫–æ–Ω—Å—Ç–∞–Ω—Ç—ã –¥–ª—è –≤—ã—Ä–∞–≤–Ω–∏–≤–∞–Ω–∏—è –∫–Ω–æ–ø–∫–∏ –ø–∞—É–∑—ã –ø–æ –≤–µ—Ä—Ç–∏–∫–∞–ª–∏: top, center, bottom
InteractiveTask.Const.prototype.PAUSE_VERTICAL_ALIGN = "top";
//  –î–æ–ø—É—Å—Ç–∏–º—ã–µ –∫–æ–Ω—Å—Ç–∞–Ω—Ç—ã –¥–ª—è –≤—ã—Ä–∞–≤–Ω–∏–≤–∞–Ω–∏—è –∫–Ω–æ–ø–∫–∏ –ø–∞—É–∑—ã –ø–æ –≥–æ—Ä–∏–∑–æ–Ω—Ç–∞–ª–∏: left, center, right
...
// –í—Ä–µ–º—è –æ—Ç–æ–±—Ä–∞–∂–µ–Ω–∏—è –æ–∫–æ–Ω –ø–µ—Ä–µ—Ö–æ–¥–æ–≤ –º–µ–∂–¥—É –∑–∞–¥–∞–Ω–∏—è–º–∏ (—É—Å–ø–µ—Ö/–Ω–µ—É–¥–∞—á–∞) –≤ –º–∏–ª–∏—Å–µ–∫—É–Ω–¥–∞—Ö
InteractiveTask.Const.prototype.SHOWING_FINAL_FRAME_TIME = 2000;

//  –ü–æ–Ω–∏–∂–∞—é—â–∏–π –∫–æ—ç—Ñ—Ñ–∏—Ü–∏–µ–Ω—Ç –¥–ª—è –∑–∞–¥–∞–Ω–∏–π
InteractiveTask.Const.prototype.DECREASING_COEFFICIENT = 0.9;

//  –ü–∞—Ä–∞–º–µ—Ç—Ä —á–∏—Å–ª–∞ –∫–∞–¥—Ä–æ–≤ –≤ —Å–µ–∫—É–Ω–¥—É –¥–ª—è –∞–Ω–∏–º–∞—Ü–∏–∏ –æ–±—ä–µ–∫—Ç–æ–≤ (–ª–∏–Ω–µ–π–Ω–∞—è –∞–Ω–∏–º–∞—Ü–∏—è —Å–æ–∑–¥–∞–Ω–Ω–∞—è –≤ –∫–æ–Ω—Å—Ç—Ä—É–∫—Ç–æ—Ä–µ)
InteractiveTask.Const.prototype.ANIMATION_FRAME_RATE = 24;

//  –ö–æ—ç—Ñ—Ñ–∏—Ü–∏–µ–Ω—Ç—ã –¥–ª—è –≤—ã—á–∏—Å–ª–µ–Ω–∏—è –¥–µ–ª—å—Ç–∞ –æ—Ç—Ä–µ–∑–∫–æ–≤ —Ç–∞–π–º–µ—Ä–∞
InteractiveTask.Const.prototype.FULL_TIME_DIVIDER = 100;
InteractiveTask.Const.prototype.TIME_DIVIDER = 10;

/*–ü–∞—Ä–∞–º–µ—Ç—Ä—ã —Ö–∏–Ω—Ç–æ–≤*/
//  –í—ã–≤–æ–¥–∏—Ç—å –ª–∏ —Ö–∏–Ω—Ç—ã
InteractiveTask.Const.prototype.IS_ADD_HINT = true;
//  –±–∞–∑–æ–≤—ã–µ –Ω–∞—Å—Ç—Ä–æ–π–∫–∏ —Ö–∏–Ω—Ç–∞ opacity - –ø—Ä–æ–∑—Ä–∞—á–Ω–æ—Å—Ç—å —Ö–∏–Ω—Ç–∞, visible - –≤–∏–¥–∏–º –ª–∏ –∏–∑–Ω–∞—á–∞–ª—å–Ω–æ —Ö–∏–Ω—Ç, listening - –¥–æ—Å—Ç—É–ø–µ–Ω –ª–∏ –¥–ª—è –ø—Ä–æ—Å–ª—É—à–∏–≤–∞–Ω–∏—è —Å–æ–±—ã—Ç–∏–π
...
//  –ù–∞–ø—Ä–∞–≤–ª–µ–Ω–∏–µ —Å—Ç—Ä–µ–ª–∫–∏ –≤ —Ö–∏–Ω—Ç–µ
...
//  –ö–Ω–æ–ø–∫–∞ —Å—Ç–∞—Ä—Ç–∞ –∑–∞–¥–∞–Ω–∏—è –¥–ª—è –∑–∞–≥—Ä—É–∑–∫–∏ –∫–æ–Ω—Ç–µ–Ω—Ç–∞ –≤ –±–∏–±–ª–∏–æ—Ç–µ–∫—É –Ω–∞ –º–æ–±–∏–ª—å–Ω—ã—Ö –¥–µ–≤–∞–π—Å–∞—Ö
...
InteractiveTask.AnimationController = function(){
	...
	//  –ë—É—Ñ–µ—Ä –∞–Ω–∏–º–∞—Ü–∏–π (–≤–Ω–∞—á–∞–ª–∞ –æ–Ω–∏ –Ω–∞–∫–∞–ø–ª–∏–≤–∞—é—Ç—Å—è –∑–¥–µ—Å—å, –∑–∞—Ç–µ–º –ø–æ—Å—Ç—É–ø–∞—é—Ç –≤ –º–∞—Å—Å–∏–≤ playAnimation, –µ—Å–ª–∏ –∏—Ö –Ω—É–∂–Ω–æ –≤–æ—Å–ø—Ä–æ–∏–∑–≤–æ–¥–∏—Ç—å)
	this.bufferAnimation = new Array();
	//  –ú–∞—Å—Å–∏–≤ –≤–æ—Å–ø—Ä–æ–∏–∑–≤–æ–¥–∏–º—ã—Ö –∞–Ω–∏–º–∞—Ü–∏–π –≤ –¥–∞–Ω–Ω—ã–π –º–æ–º–µ–Ω—Ç
...
//  –°—Ç–∞—Ä—Ç –∞–≤—Ç–æ–º–∞—Ç–∏—á–µ—Å–∫–∏—Ö –∞–Ω–∏–º–∞—Ü–∏–π –≤ –Ω–∞—á–∞–ª–µ –∑–∞–¥–∞–Ω–∏—è
InteractiveTask.AnimationController.prototype.totalPlaye = function(){
	var i, l, n;
	l = this.bufferAnimation.length;
	var flag = false;
	for(i=0;i<l;i++){
		//  –ï—Å–ª–∏ –∞–Ω–∏–º–∞—Ü–∏—é –Ω—É–∂–Ω–æ —Å—Ç–∞—Ä—Ç–æ–≤–∞—Ç—å –∞–≤—Ç–æ–º–∞—Ç–∏—á–µ—Å–∫–∏
	  	if(this.bufferAnimation[i].isAutoPlay()){
		    flag = true;
		    //  –†–∞—Å—Å—á–∏—Ç—ã–≤–∞–µ–º –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω—ã–µ —Ç–æ—á–∫–∏
		    this.bufferAnimation[i].middlePointsAnimation();
		    //  –û—Ç–ø—Ä–∞–≤–ª—è–µ–º –æ–±—ä–µ–∫—Ç –≤ —Å–ª–æ–π –∞–Ω–∏–º–∞—Ü–∏–∏
		    this.bufferAnimation[i].moveToAnimationLayer();
		    //  –û—Ç–ø—Ä–∞–≤–ª—è–µ–º –≤ –º–∞—Å—Å–∏–≤ –∞–Ω–∏–º–∞—Ü–∏–π –ø—Ä–æ–∏–≥—Ä—ã–≤–∞–Ω–∏—è  –∏ –í—ã—Ä–µ–∑–∞–µ–º –µ—ë –∏–∑ –±—É—Ñ–µ—Ä–∞
		    ...
		    //  –ø–æ—Å–∫–æ–ª—å–∫—É –º—ã –≤—ã—Ä–µ–∑–∞–ª–∏ –∞–Ω–∏–º–∞—Ü–∏—é –∏–∑ –±—É—Ñ–µ—Ä–∞, —Ç–æ –ø–æ–Ω–∏–∂–∞–µ–º –∏ –Ω–¥–µ–∫—Å –∏ –¥–ª–∏–Ω—É –º–∞—Å—Å–∏–≤–∞ –±—É—Ñ–µ—Ä–∞
		    --l;
		    --i;
	    };
	};
...
//	console.log("animation play");
	...
	var flag = false;
	if(l>0){
		//  –ü–æ –≤—Å–µ–º –∞–Ω–∏–º–∞—Ü–∏—è–º –ø—Ä–æ–∏–≥—Ä—ã–≤–∞–Ω–∏—è –ø–µ—Ä–µ–º–µ—â–∞–µ–º –æ–±—ä–µ–∫—Ç—ã –≤ –Ω–æ–≤—ã–µ —Ç–æ—á–∫–∏
		for(i=0;i<l;i++){
	...
	//  –ï—Å–ª–∏ –º–∞—Å—Å–∏–≤ –±—É—Ñ–µ—Ä–∞ –ø—É—Å—Ç –∏ –º–∞—Å—Å–∏–≤ —Ç–µ–∫—É—â–µ–π –∞–Ω–∏–º–∞—Ü–∏–∏ —Ç–∞–∫–∂–µ –ø—É—Å—Ç, —Ç–æ –æ—Å—Ç–∞–Ω–∞–≤–ª–∏–≤–∞–µ–º –ø–æ—Ç–æ–∫ –∞–Ω–∏–º–∞—Ü–∏–∏
	var self = this;
...
/************************************************************************************************************************/
/************–û–±—ä–µ–∫—Ç —Å–æ–¥–µ—Ä–∂–∞—â–∏–π –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω—ã–µ —Å–æ—Å—Ç–æ—è–Ω–∏—è –∞–Ω–∏–º–∏—Ä—É–µ–º–æ–≥–æ –æ–±—ä–µ–∫—Ç–∞ –∏ –º–µ—Ç–æ–¥—ã –∏–∑–º–µ–Ω–µ–Ω–∏—è –æ–±—ä–µ–∫—Ç–∞*******************/
/************************************************************************************************************************/
...
InteractiveTask.AnimationObject.prototype.parseXML = function(){
	//alert("parseXml");
	//  –ó–∞–ø–æ–º–∏–Ω–∞–µ–º —à–∞–≥ –∞–Ω–∏–º–∞—Ü–∏–∏
	this.step = parseFloat(this.xml["-step"]);
	//  –ó–∞–ø–æ–º–∏–Ω–∞–µ–º –≤—Ä–µ–º—è —á–µ—Ä–µ–∑ –∫–æ—Ç–æ—Ä–æ–µ –Ω–µ–æ–±—Ö–æ–¥–∏–º–æ —Å—Ç–∞—Ä—Ç–æ–≤–∞—Ç—å –∞–Ω–∏–º–∞—Ü–∏—é
	this.startFrom = parseFloat(this.xml["-startTime"]);
	//  –ó–∞—Ü–∏–∫–ª–∏–≤–∞—Ç—å –∏–ª–∏ –Ω–µ—Ç –∞–Ω–∏–º–∞—Ü–∏—é
	this.cicling = (this.xml["-cicling"] == "true");
	//  –£—Å—Ç–∞–Ω–∞–≤–ª–∏–≤–∞—Ç—å –Ω–∞—Å—Ç—Ä–æ–π–∫–∏ –ø–µ—Ä–≤–æ–π —Ç–æ—á–∫–∏ –∏–ª–∏ –Ω–µ—Ç
	var isFirstPointSettings = (this.xml["-firstPoint"] == "true");
	//  –£–¥–∞–ª—è—Ç—å –ª–∏ –æ–±—ä–µ–∫—Ç –ø–æ –∑–∞–≤–µ—Ä—à–µ–Ω–∏–∏ –∞–Ω–∏–º–∞—Ü–∏–∏
	this.isRemoveObject = (this.xml["-removeObject"] == "true");
	//  –£—Å—Ç–∞–Ω–∞–≤–ª–∏–≤–∞–µ–º —á–∏—Å–ª–æ –∑–∞–ø—Ä–æ—Å–æ–≤ –¥–æ –∑–∞–ø—É—Å–∫–∞ –∞–Ω–∏–º–∞—Ü–∏–∏
	if(this.xml["-address"]!="") this.address = parseInt(this.xml["-address"]);
	//  –û–ø—Ä–µ–¥–µ–ª—è–µ–º –Ω–µ–æ–±—Ö–æ–¥–∏–º –ª–∏ –º–Ω–æ–∂–µ—Å—Ç–≤–µ–Ω–Ω—ã–π –∑–∞–ø—É—Å–∫ –∞–Ω–∏–º–∞—Ü–∏–∏
	this.multiple = (this.xml["-multiple"]=="true");
	//  –û–ø—Ä–µ–¥–µ–ª—è–µ–º –±—É–¥–µ—Ç –ª–∏ –∞–Ω–∏–º–∞—Ü–∏—è —Å—Ç–∞—Ç–∏—á–µ—Å–∫–æ–π, —Ç.–µ. –¥–≤–∏–∂–µ–Ω–∏–µ –∫–æ –≤—Ç–æ—Ä–æ–π —Ç–æ—á–∫–µ —Å —Ç–µ–∫—É—â–µ–π –ø–æ–∑–∏—Ü–∏–∏ –∏–ª–∏ –≤–æ–∑–≤—Ä–∞—Ç –Ω–∞ –ø–µ—Ä–≤—É—é —Ç–æ—á–∫—É
	this.animationStatic = (this.xml["-static"]=="true");
	//  –º–µ—Ç–∫–∞ –¥–ª—è –∑–∞–ø—É—Å–∫–∞ –∞–Ω–∏–º–∞—Ü–∏–∏
	this.label = this.xml["-label"];

	// –°–æ–∑–¥–∞–µ–º –º–∞—Å—Å–∏–≤ –∫–ª—é—á–µ–≤—ã—Ö —Ç–æ—á–µ–∫
	...
	// –ï—Å–ª–∏ –≤ –º–∞—Å—Å–∏–≤–µ –∫–ª—é—á–µ–≤—ã—Ö —Ç–æ—á–µ–∫ —Å—É—â–µ—Å—Ç–≤—É—é—Ç –æ—Ç—Ä–∏—Ü–∞—Ç–µ–ª—å–Ω—ã–µ –ø–æ–≤–æ—Ä–æ—Ç—ã, —Ç–æ –¥–µ–ª–∞–µ–º –∏—Ö –ø–æ–ª–æ–∂–∏—Ç–µ–ª—å–Ω—ã–º–∏
	var i,l;
	...
	//  –ù–∞—Å—Ç—Ä–∞–∏–≤–∞–µ–º –æ–±—ä–µ–∫—Ç –ø–æ –ø–µ—Ä–≤–æ–π —Ç–æ—á–∫–µ, –µ—Å–ª–∏ —ç—Ç–æ –Ω–µ–æ–±—Ö–æ–¥–∏–º–æ
...
//  –ú–µ—Ç–æ–¥ –ø—Ä–æ—Å—á–µ—Ç–∞ –≤—Å–µ—Ö –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω—ã—Ö —Ç–æ—á–µ–∫ –∞–Ω–∏–º–∞—Ü–∏–∏ —Å —Ç–∞–π–º–∞—É—Ç–∞–º–∏
InteractiveTask.AnimationObject.prototype.middlePointsAnimation = function(){
	...
	//  –ï—Å–ª–∏ –∞–Ω–∏–º–∞—Ü–∏—è –Ω–∞—á–∏–Ω–∞–µ—Ç—Å—è —Å —Ç–µ–∫—É—â–µ–π —Ç–æ—á–∫–∏, —Ç–æ –Ω–∞—Å—Ç—Ä–∞–∏–≤–∞–µ–º –Ω–æ–≤—ã–µ –ø–æ–≤–æ—Ä–æ—Ç –∏ –ø–æ–∑–∏—Ü–∏—é
	...
	var ID = 0;
	//  –¥–µ–ª—å—Ç–∞ –ø–µ—Ä–µ–º–µ—â–µ–Ω–∏–µ –æ–±—ä–µ–∫—Ç–∞
	var deltaX, deltaY;
	//  –î–µ–ª—å—Ç—ã –ø–æ–≤–æ—Ä–æ—Ç–∞, –º–∞—Å—à—Ç–∞–±–∏—Ä–æ–≤–∞–Ω–∏—è –∏ –ø—Ä–æ–∑—Ä–∞—á–Ω–æ—Å—Ç–∏ —Å–æ–æ—Ç–≤–µ—Ç—Å—Ç–≤–µ–Ω–Ω–æ
	var deltaR, deltaS, deltaA;
	//  –î–µ–ª—å—Ç–∞ —Ü–≤–µ—Ç–∞ –ø–æ —Å–ø–µ–∫—Ç—Ä–∞–º
	var deltaRed, deltaGreen, deltaBlue;
	//	–ß–∏—Å–ª–æ —á–∞—Å—Ç–µ–π –Ω–∞ –∫–æ—Ç–æ—Ä–æ–µ –¥–µ–ª–∏—Ç—Å—è –æ—Ç—Ä–µ–∑–æ–∫ –∞–Ω–∏–º–∞—Ü–∏–∏
	var sempleTime = Math.floor(InteractiveTask.CONST.ANIMATION_FRAME_RATE*this.step);

	var i,j,l;
	l = this.keyPoints.length;
	//	–≤—ã—á–∏—Å–ª—è–µ–º –Ω–∞—á–∞–ª—å–Ω—ã–µ –∑–Ω–∞—á–µ–Ω–∏—è —Ü–≤–µ—Ç–∞
	var r,g,b;
	...
	//  –°–æ–∑–¥–∞–µ–º –º–∞—Å—Å–∏–≤ –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω—ã—Ö —Ç–æ—á–µ–∫ –∞–Ω–∏–º–∞—Ü–∏–∏
	this.arrayAnimationPoints = new Array();
	//  –ï—Å–ª–∏ –Ω—É–∂–Ω–æ –∑–∞–ø—É—Å—Ç–∏—Ç—å –∞–Ω–∏–º–∞—Ü–∏—é —á–µ—Ä–µ–∑ –Ω–µ–∫–æ—Ç–æ—Ä–æ–µ –≤—Ä–µ–º—è, —Ç–æ —Å—Ç–∞–≤–∏–º –≤ –º–∞—Å—Å–∏–≤ –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω—ã—Ö —Ç–æ—á–µ–∫ –ø–æ–¥—Ö–æ–¥—è—â–µ–µ –∫–æ–ª–∏—á–µ—Å—Ç–≤–æ
	//  –?–Ω–∞—á–µ –∑–∞–ø–∏—Å—ã–≤–∞–µ–º —Ç–æ–ª—å–∫–æ –æ–¥–Ω—É –ø–µ—Ä–≤—É—é —Ç–æ—á–∫—É
	...
	//	–ü—Ä–æ—Å—á–∏—Ç—ã–≤–∞–µ–º –ø–æ–∑–∏—Ü–∏–∏ –¥–ª—è –∫–∞–∂–¥–æ–≥–æ –æ—Ç—Ä–µ–∑–∫–∞
	var currentRed, currentBlue, currentGreen;
	if(this.step!=0){
		for(i=1;i<l;i++){
			//	–ü—Ä–æ—Å—á—ë—Ç —Å–º–µ—â–µ–Ω–∏–π –ø–æ –æ—Å—è–º –¥–ª—è —Ç–µ–∫—É—â–µ–≥–æ –æ—Ç—Ä–µ–∑–∫–∞
			...
			//	–í—ã—á–∏—Å–ª—è–µ–º —Å–º–µ—â–µ–Ω–∏–µ –∫–∞–∂–¥–æ–≥–æ —Å–ø–µ–∫—Ç—Ä–∞ —Ü–≤–µ—Ç–∞
			if(this.object!=null){
			...
			//	–ó–∞–ø–∏—Å—å –≤ –º–∞—Å—Å–∏–≤ –≤—Å–µ—Ö –∞–Ω–∏–º–∞—Ü–∏–æ–Ω–Ω—ã—Ö —Ç–æ—á–µ–∫
			for(j=0;j<sempleTime;j++){
				//  –û–ø—Ä–µ–¥–µ–ª—è–µ–º –∏–Ω–¥–µ–∫—Å –Ω–æ–≤–æ–π —Ç–æ—á–∫–∏
				ID = this.arrayAnimationPoints.length;
				//  –í—ã—á–∏—Å–ª—è–µ–º —Ü–≤–µ—Ç –æ–±—ä–µ–∫—Ç–∞ –≤ —Ç–µ–∫—É—â–µ–π —Ç–æ—á–∫–µ
				...
				//  –ó–∞–ø–∏—Å—ã–≤–∞–µ–º –Ω–æ–≤—É—é –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω—É—é —Ç–æ—á–∫—É
			...
			//  –ï—Å–ª–∏ –Ω–∞ —Å–ª–µ–¥—É—é—â–µ–π —Ç–æ—á–∫–µ –∞–Ω–∏–º–∞—Ü–∏–∏ –Ω—É–∂–µ–Ω —Ç–∞–π–º–∞—É—Ç, —Ç–æ –∑–∞–ø–∏—Å—ã–≤–∞–µ–º —Å—Ç–æ–ª—å–∫–æ –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω—ã—Ö —Ç–æ—á–µ–∫ —Ä–∞–≤–Ω—ã—Ö —Å–ª–µ–¥—É—é—â–µ–π, —Å–∫–æ–ª—å–∫–æ –Ω–µ–æ–±—Ö–æ–¥–∏–º–æ
	...
	//	–£–¥–∞–ª—è–µ–º –ø–µ—Ä–≤—É—é —Ç–æ—á–∫—É –¥–ª—è –±–æ–ª–µ–µ –ø–ª–∞–≤–Ω–æ–≥–æ –ø–µ—Ä–µ—Ö–æ–¥–∞ –ø—Ä–∏ –∑–∞—Ü–∏–∫–ª–∏–≤–∞–Ω–∏–∏ –∞–Ω–∏–º–∞—Ü–∏–∏
	this.arrayAnimationPoints.shift();
};

//  –§—É–Ω–∫—Ü–∏—è –ø–µ—Ä–µ—Ö–æ–¥–∞ –∫ —Å–ª–µ–¥—É—é—â–µ–π –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω–æ–π —Ç–æ—á–∫–µ –∞–Ω–∏–º–∞—Ü–∏–∏
InteractiveTask.AnimationObject.prototype.gotoNextPoint = function(){
	//  –ü–µ—Ä–≤—É—é —Ç–æ—á–∫—É –∏–∑ –º–∞—Å—Å–∏–≤–∞ –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω—ã—Ö —Ç–æ—á–µ–∫, –∑–∞–ø–æ–º–∏–Ω–∞–µ–º –µ—ë –∏ —É–¥–∞–ª—è–µ–º –∏–∑ –º–∞—Å—Å–∏–≤–∞
	var currentPoint = this.arrayAnimationPoints.shift();
	//  –ü–µ—Ä–µ–Ω–æ—Å–∏–º, –ø–æ–≤–æ—Ä–∞—á–∏–≤–∞–µ–º, –º–∞—Å—à—Ç–∞–±–∏—Ä—É–µ–º –∏ –∏–∑–º–µ–Ω—è–µ–º –ø—Ä–æ–∑—Ä–∞—á–Ω–æ—Å—Ç—å –æ–±—ä–µ–∫—Ç–∞
	...
	//  –ï—Å–ª–∏ –∞–Ω–∏–º–∞—Ü–∏—è –∑–∞—Ü–∏–∫–ª–∏–Ω–∞, —Ç–æ —Å—Ç–∞–≤–∏–º –ø–µ—Ä–≤—É—é —Ç–æ—á–∫—É –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω–æ–π –∞–Ω–∏–º–∞—Ü–∏–∏ –≤ –∫–æ–Ω–µ—Ü –º–∞—Å—Å–∏–≤–∞, –∏–Ω–∞—á–µ –æ–Ω–∞ –æ—Å—Ç–∞–µ—Ç—Å—è —É–¥–∞–ª–µ–Ω–Ω–æ–π
	if(this.cicling){
...
//  –ü—Ä–æ–≤–µ—Ä–∫–∞ –Ω–∞ –∑–∞–≤–µ—Ä—à–µ–Ω–∏–µ –∞–Ω–∏–º–∞—Ü–∏–∏ (–≤ —Å–ª—É—á–∞–µ –µ—Å–ª–∏ –º–∞—Å—Å–∏–≤ –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω—ã—Ö —Ç–æ—á–µ–∫ –ø—É—Å—Ç–æ–π)
InteractiveTask.AnimationObject.prototype.isComplate = function(){
	return this.arrayAnimationPoints.length==0;
};
//  –ü—Ä–æ–≤–µ—Ä–∫–∞, –º–æ–∂–Ω–æ –ª–∏ –∑–∞–ø—É—Å—Ç–∏—Ç—å –∞–Ω–∏–º–∞—Ü–∏—é (–∏—Å—á–µ—Ä–ø–∞–Ω –ª–∏ –ª–∏–º–∏—Ç –∑–∞–ø—Ä–æ—Å–æ–≤ –∫ –Ω–µ–π)
InteractiveTask.AnimationObject.prototype.canGetObject = function(){
	if(this.address==0) return true;
	--this.address;
	return false;
};
//  –ü—Ä–æ–≤–µ—Ä–∫–∞ –∞–≤—Ç–æ–º–∞—Ç–∏—á–µ—Å–∫–∏ –ª–∏ –∑–∞–ø—É—Å–∫–∞–µ—Ç—Å—è –∞–Ω–∏–º–∞—Ü–∏—è
...
//  –ó–∞–ø–∏—Å—å –∫–ª—é—á–µ–≤—ã—Ö —Ç–æ—á–µ–∫ –≤ –º–∞—Å—Å–∏–≤ –ø—Ä–æ–º–µ–∂—É—Ç–æ—á–Ω—ã—Ö –∞–Ω–∏–º–∞—Ü–∏–π
...
/**
 * ÙÛÌÍˆËˇ ‰Îˇ ÛÒÚ‡ÌÓ‚ÍË ‚‡˘ÂÌËˇ Ë ÔÂÂÏÂ˘ÂÌËˇ Ú‡ÌÓ‚ (ÔÓÎ¸ÁÓ‚‡ÚÂÎ¸ÒÍËı Ë ˆ‚ÂÚÌ˚ı)
 * @param self - Ó·˙ÂÍÚ Ú‡Ì‡ ÍÓÚÓ˚È ‰ÓÎÊÂÌ ÔÂÂÏÂ˘‡Ú¸Òˇ
 * @param event - ÒÓ·˚ÚËÂ Ì‡Ê‡ÚËˇ Ì‡ Ú‡Ì ‰Îˇ ÓÔÂ‰ÂÎÂÌËˇ ÒÂÌÒÓÌÓ„Ó ÒÓ·˚ÚËˇ
 */
 ...
 * @param target
 * @param options = {
 *    isRotate : boolean,           - ÕÛÊÌÓÎË ÔÓ‚Ó‡˜Ë‚‡Ú¸ Ó·˙ÂÍÚ
 *    isDrag : boolean,             - ÕÛÊÌÓ ÎË ÔÂÂÏÂ˘‡Ú¸ Ó·˙ÂÍÚ
 *    layer : Konva.Layer,          - —ÎÓÈ ‚ ÍÓÚÓÓÏ Ì‡ıÓ‰ËÚÒˇ Ó·˙ÂÍÚ ‰Ó ˝ÚÓÈ ÙÛÌÍˆËË
 *    callback() : Function         - ‘ÛÌÍˆËˇ, ÍÓÚÓÛ˛ ÌÛÊÌÓ ‚˚Á‚‡Ú¸ ÔÓÒÎÂ Á‡‚Â˘ÂÌËˇ ‡·ÓÚ˚ Ò Ó·˙ÂÍÚÓÏ
 *    rotate(degree) : Function     - ‘ÛÌÍˆËˇ ‚˚ÔÓÎÌˇÂÏ‡ˇ ÔË ˝ÎÂÏÂÌÚ‡ÌÓÏ ÔÓ‚ÓÓÚÂ
 * }
 */
...
/**
 *
 * @param time - ÒÚÓÍÓ‚ÓÂ ÔÂ‰ÒÚ‡‚ÎÂÌËÂ ‚ÂÏÂÌË ‚ÒÂ„Ó ÔˇÚ¸ ÒËÏ‚ÓÎÓ‚
 *  œÂ‚˚Â ‰‚‡ - ÏËÌÛÚ˚
 *  œÓÒÎÂ‰ÌËÂ ‰‚‡ - ÒÂÍÛÌ‰˚
 *  ¬ ˆÂÌÚÂ - ‡Á‰ÂÎËÚÂÎ¸
 */
...
/**
 * ‘ÛÌÍˆËˇ ‚ÓÒÔÓËÁ‚Â‰ÂÌËˇ ‚ÌÂ¯ÌÂ„Ó Á‚ÛÍ‡ (Á‡‚Â¯ÂÌËÂ/Ì‡˜‡ÎÓ Á‡‰‡ÌËˇ)
 * @param player - Ó·˙ÂÍÚ ÔÎÂÂ‡ ‚ ÍÓÚÓÓÏ ‚˚Á˚‚‡ÂÚÒˇ ÔÓ‰ÓÎÊÂÌËÂ Á‡‰‡ÌËˇ
 */
InteractiveTask.audioControl = function(player){
	...
	var playAudio;
	/**
	 * »ÌËˆË‡ÎËÁ‡ˆËˇ ÌÓ‚Ó„Ó ‡Û‰ËÓÙ‡ÈÎ‡
	 * @param src - ÒÒ˚ÎÍ‡ Ì‡ Ù‡ÈÎ   InteractiveTask.AUDIO.init(InteractiveTask.PATH+"audio/"+this.getStartAudioID(this.currentTaskID)+".wav", false);
	 * @param isDispatch - ÔÓËÁ‚Ó‰ËÚ¸ ÎË ÔÓ‰ÓÎÊÂÌËÂ Á‡‰‡ÌËÈ ÔÓÒÎÂ ÔÓË„˚‚‡ÌËˇ Á‚ÛÍ‡
	 */
