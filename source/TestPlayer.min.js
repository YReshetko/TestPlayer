...
InteractiveTask.AnimationObject.prototype.middlePointsAnimation = function(){
	...
	//  �?наче записываем только одну первую точку
...
InteractiveTask.AnimationSprite.prototype.parseXML = function(){
	...
	//  метка для запуска анимации
	this.label = this.xml["-label"];
	//  �?мя текущей анимации  animation : 'standing'
...
InteractiveTask.audioControl = function(player){
	...
	/**
	 * ������������� ������ ����������
	 * @param src - ������ �� ����   InteractiveTask.AUDIO.init(InteractiveTask.PATH+"audio/"+this.getStartAudioID(this.currentTaskID)+".wav", false);
	 * @param isDispatch - ����������� �� ����������� ������� ����� ������������ �����
	 */
